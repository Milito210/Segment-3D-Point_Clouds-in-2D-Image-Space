...
hdf5_data_folder = 'hdf5_data'
dataset_filename = 'ShapeNet_prepro.hdf5'
model_filename = 'ShapeNet_model.h5'
dataset_path = os.path.join(hdf5_data_folder, dataset_filename)
model_path = os.path.join(hdf5_data_folder, model_filename)
save_path = os.path.join(hdf5_data_folder, 'trained_model.h5')
